...
#line 37 "examples/calc++/calc++-parser.cc" // lalr1.cc:399
...
#line 51 "examples/calc++/calc++-parser.cc" // lalr1.cc:407
// Unqualified %code blocks.
#line 11240 "./doc/bison.texi" // lalr1.cc:408

# include "calc++-driver.hh"

#line 57 "examples/calc++/calc++-parser.cc" // lalr1.cc:408
...
namespace yy {
#line 143 "examples/calc++/calc++-parser.cc" // lalr1.cc:474
...
#line 11288 "./doc/bison.texi" // lalr1.cc:617
        { yyoutput << yysym.value.template as< std::string > (); }
#line 314 "examples/calc++/calc++-parser.cc" // lalr1.cc:617
        break;
...
#line 321 "examples/calc++/calc++-parser.cc" // lalr1.cc:617
        break;
...
#line 11288 "./doc/bison.texi" // lalr1.cc:617
        { yyoutput << yysym.value.template as< int > (); }
#line 328 "examples/calc++/calc++-parser.cc" // lalr1.cc:617
        break;
  ...
  calcxx_parser::parse ()
  {
    ...
    #line 11215 "./doc/bison.texi" // lalr1.cc:725
{
  // Initialize the initial location.
  yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 450 "examples/calc++/calc++-parser.cc" // lalr1.cc:725
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 11299 "./doc/bison.texi" // lalr1.cc:847
    { driver.result = yystack_[0].value.as< int > (); }
#line 573 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 3:
#line 11302 "./doc/bison.texi" // lalr1.cc:847
    {}
#line 579 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 4:
#line 11303 "./doc/bison.texi" // lalr1.cc:847
    {}
#line 585 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 5:
#line 11306 "./doc/bison.texi" // lalr1.cc:847
    { driver.variables[yystack_[2].value.as< std::string > ()] = yystack_[0].value.as< int > (); }
#line 591 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 6:
#line 11311 "./doc/bison.texi" // lalr1.cc:847
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () + yystack_[0].value.as< int > (); }
#line 597 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 7:
#line 11312 "./doc/bison.texi" // lalr1.cc:847
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () - yystack_[0].value.as< int > (); }
#line 603 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 8:
#line 11313 "./doc/bison.texi" // lalr1.cc:847
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () * yystack_[0].value.as< int > (); }
#line 609 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 9:
#line 11314 "./doc/bison.texi" // lalr1.cc:847
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () / yystack_[0].value.as< int > (); }
#line 615 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 10:
#line 11315 "./doc/bison.texi" // lalr1.cc:847
    { std::swap (yylhs.value.as< int > (), yystack_[1].value.as< int > ()); }
#line 621 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 11:
#line 11316 "./doc/bison.texi" // lalr1.cc:847
    { yylhs.value.as< int > () = driver.variables[yystack_[0].value.as< std::string > ()]; }
#line 627 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;

  case 12:
#line 11317 "./doc/bison.texi" // lalr1.cc:847
    { std::swap (yylhs.value.as< int > (), yystack_[0].value.as< int > ()); }
#line 633 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
    break;


#line 637 "examples/calc++/calc++-parser.cc" // lalr1.cc:847
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  {
       0, 11299, 11299, 11302, 11303, 11306, 11311, 11312, 11313, 11314,
   11315, 11316, 11317
  };
...
#line 1014 "examples/calc++/calc++-parser.cc" // lalr1.cc:1155
#line 11318 "./doc/bison.texi" // lalr1.cc:1156
